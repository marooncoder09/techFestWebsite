  ...
  return (
    ...
    >
          <div className='text-center'>
                <motion.h2 initial={{ y: 100, opacity: 0 }} animate={inView ? { y: 0, opacity: 1 } : {}} transition={{ duration: 0.5 }} className={styles.sectionTitle}>ABOUT US</motion.h2>
      ...
      <div className="relative">
        ...
        >
         Glitch Tech Fest 2024 offers an unparalleled opportunity for students to connect with peers and industry experts across various technological domains. Showcasing modern skills and talents, participants stand out while gaining invaluable insights from live interactions with professionals. Beyond networking, the fest fosters friendships and offers diverse events tailored to individual interests, laying a strong foundation for future career endeavors.
        </motion.p>
      ...
      <motion.p
        ...
        style={suarte.style}
      >
        Embrace Imperfections, Elevate Innovation
      </motion.p>
    </section>
  );
}
